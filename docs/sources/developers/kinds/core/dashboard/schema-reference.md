...
| `sidePanel`            | integer                           | No       | The floating panel id to show on the left side of the dashboard. Hidden if empty                                                                                                                                        |
| `tabs`                 | integer                           | No       | The floating panel id to show on the left side of the dashboard. Hidden if empty                                                                                                                                        |
