...
func getServerBounds() (b *Bounds, e error) {
	...
	// TODO: Make this configurable like original pg_tileserv
	srid := 3857
	...
	// logger.Info(fmt.Sprintf("Using CoordinateSystem.SRID %d with bounds [%g, %g, %g, %g]",
