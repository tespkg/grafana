...
func (srv *ProvisioningSrv) RouteGetAlertRulesExport(c *models.ReqContext) response.Response {
...
func (srv *ProvisioningSrv) RouteGetAlertRuleExport(c *models.ReqContext, UID string) response.Response {
